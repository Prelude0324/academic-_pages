...
1. [JRC Hydro-power plants database](https://github.com/energy-modelling-toolkit/hydro-power-database)
...
3. [GHG Emission Factors Hub](https://www.epa.gov/climateleadership/ghg-emission-factors-hub)

<h2>2. Reanalysis data</h2>

1. [Data: NOAA Physical Sciences Laboratory](https://psl.noaa.gov/data/index.html)
2. [ECMWF Datasets](https://www.ecmwf.int/en/forecasts/datasets)
...
2. [GlobalDamWatch](https://www.globaldamwatch.org/database)
